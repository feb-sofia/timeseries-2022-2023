...
$$
h^2_t = \alpha_0 + \alpha_1 e^2_t + \ldots + \alpha_q e^2_{t - q} + \beta_1 h^2_{t - 1} + \ldots + \beta_p h^2_{t - p}
$$

It is easy to show that under the GARCH(q, p) model the squard error terms $e^2_t$ is an ARMA process.
...
$$
h^2_t = \alpha_0 + \alpha e^2_{t - 1} + \beta h^2_t, \quad \alpha_0, \alpha, \beta > 0
$$
